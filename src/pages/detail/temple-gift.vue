<template>
  <ul class="ticket-container clearfix">
    <h3 class="ticket-type">
      ...
      {{templeGift.templeGiftTitle}}
    </h3>
    <li class="ticket-info-container" v-for="item of templeGift.templeGiftList" :key="item">
    ...
    <li class="ticket-info-container" v-show="!isShow" v-for="seeMore of templeGift.seeMore" :key="seeMore">
      <div class="ticket-info">
        <h5 class="ticket-info-name">
          {{seeMore.info}}<!-- <br/> -->
          <span class="rely-on-idCard-enter-park">
