<template>
  <ul class="ticket-container clearfix">
    <h3 class="ticket-type">
      ...
      {{oneDayTour.oneDayTourTitle}}
    </h3>
    <li class="ticket-info-container" v-for="item of oneDayTour.oneDayTourList" :key="item">
    ...
    <li
      class="ticket-info-container" v-show="!isShow" v-for="seeMore of oneDayTour.seeMore" :key="seeMore">
      <div class="ticket-info">
        <h5 class="ticket-info-name">
          {{seeMore.info}}<!-- <br/> -->
        </h5>
