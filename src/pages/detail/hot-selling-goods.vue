<template>
  <ul class="ticket-container clearfix">
    <h3 class="ticket-type">
      ...
      {{hotSellingGoodsList.ticketTypeTitle}}
    </h3>
    <li class="ticket-info-container" v-for="item of hotSellingGoodsList.ticketAdultInfo" :key="item">
      <div class="ticket-info">
        <h5 class="ticket-info-name">
          {{item.ticketInfoName}}<!-- <br/> -->
    ...
    <li class="ticket-info-container" v-show="!isShow" v-for="seeMore of hotSellingGoodsList.seeMore" :key="seeMore">
      <div class="ticket-info">
        <h5 class="ticket-info-name">
          {{seeMore.ticketInfoName}}<!-- <br/> -->
          <span class="rely-on-idCard-enter-park">
            {{seeMore.relyOnIdCardEnterPark}}
          </span>
        </h5>
      </div>
      <div class="ticket-price-container">
        ¥
        <em class="ticket-price">{{seeMore.ticketPrice}}</em>
        <span class="ticket-num-word">起</span>
      </div>
      <span class="iconfont icon-down-arrow">&#xe62f;</span>
    </li>
