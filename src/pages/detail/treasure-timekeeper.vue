<template>
  <ul class="ticket-container clearfix">
    <h3 class="ticket-type">
      ...
      {{treasureAndTimekeeper.treasureAndTimekeeper}}
    </h3>
    <li class="ticket-info-container" v-for="item of treasureAndTimekeeper.treasureAndTimekeeperInfo" :key="item">
...
<script>
export default {
  name: 'treasure-timekeeper',
  props: {
    treasureAndTimekeeper: Object
  },
  data () {
    return {
      isShow: true
